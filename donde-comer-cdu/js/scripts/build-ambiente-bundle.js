 ...
 * comentarios de documentación — valiosos para quien EDITA
 * js/ambiente-*.js, puro peso muerto para quien solo los descarga y
 * ejecuta. Se conservan intactos en los módulos fuente; acá se usa
 * terser en modo conservador — SOLO strip de comentarios y espacios
 * (`compress:false, mangle:false`), CERO reescritura de lógica o
 * nombres. La cabecera "GENERADO, NO EDITAR A MANO" se preserva
 * explícitamente (ver `comments` en minificar() abajo).
 */
